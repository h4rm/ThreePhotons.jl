...
type BasisType <: AbstractBasisType
    ...
    function BasisType( wignerlist::Array{Float64,1}, indices::Array{Int64,2}, PAcombos::Array{Int64,2}, B::Array{Float32,2}, h_P::Array{Float32,2}, basislen::Int64, N::Int64, L::Int64, LMAX::Int64, lrange::StepRange, ctr::Dict, rtc::Dict, K::Int64, lambda::Float64, dq::Float64)
...
function correct_beamstop(c2::C2, c3::C3, c2_beamstop::C2, c3_beamstop::C3)
    #Renormalize c2
