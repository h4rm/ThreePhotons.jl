function run_determination(dir::String; histograms::String="", initial_stepsize::Float64=Float64(pi), K3_range::Integer=1:8, L::Integer=8, optimizer::String="rotate_hierarchical", initial_temperature_factor::Float64=1.0, temperature_decay::Float64=0.99, N::Integer=32, range=1000:1019, fresh::Bool=false, gpu::Bool=true, Ncores::Integer=8, successive_jobs::Integer=1, measure="Bayes", postprocess::Bool=true, stepsizefactor::Float64=1.02, K2_range::Int64=1:35, qmax::Float64=1.0, force_repostprocess::Bool=false, run_denoise::Bool=false, architecture::String="ivy-bridge|sandy-bridge|haswell|broadwell|skylake", hours::Int64=48, sigma::Float64=0.0, reference_pdb_path::String="", lambda::Float64=0.0, include_negativity::Bool=false)
...
# run_determination("exp_data/coliphage_determination_negativity", histograms="$(ENV["DETERMINATION_DATA"])/output_owl/exp_data/coliphage_symmetric_N32/histo.dat", lambda=lambda, initial_stepsize=pi/4.0, K3_range=1:26, L=18, K2_range=1:38, qmax=pi/116, optimizer="rotate_all_at_once", initial_temperature_factor=0.1, temperature_decay=0.99998, N=32, successive_jobs=3, measure="Bayes", range=1000:1019, postprocess=false, gpu=true, Ncores=20, stepsizefactor=1.01, include_negativity=false)
