...
#Coliphage with symmetric and L=12
# run_determination("exp_data/coliphage_determination_paper", histograms="$(ENV["DETERMINATION_DATA"])/output_owl/exp_data/coliphage_symmetric/histo.dat", lambda=7.75, initial_stepsize=pi/4.0, K3_range=4:30, L=12, K2_range=4:38, qmax=pi/90.0, optimizer="rotate_all_at_once", initial_temperature_factor=0.1, temperature_decay=0.99998, N=32, successive_jobs=3, measure="Bayes", range=1000:1019, postprocess=false, gpu=true, Ncores=20, stepsizefactor=1.01, include_negativity=false)
