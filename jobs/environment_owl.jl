...
#memory=4G
#gpu_mem=4000M
function jobengine_head(name::String, dir::String, Ncores::Integer, gpu::Bool; hours::Int64=48, architecture::String="", memory::String="", gpu_mem::String="4000M")
    ...
    #\$ -e $dir/terminal-err
    #\$ -o $dir/terminal-out
    $(architecture != "" ? "#\$ -l cm=$(architecture)" : "")
    #\$ -N $(jobname(name))
    #\$ -M bardenn@gwdg.de
    #\$ -m n
    #\$ -l h_rt=$(hours):00:00
...
function launch_job(dir::String, Ncores::Integer, gpu::Bool, julia_script::String, successive_jobs::Integer=1; hours::Int64=48, architecture::String="", memory::String="", fresh::Bool=false, gpu_mem::String="4000M")
