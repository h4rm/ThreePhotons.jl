...
function launch_job(dir::String, Ncores::Integer, gpu::Bool, julia_script::String, successive_jobs::Integer=1; hours::Int64=48, architecture::String="", memory::String="", fresh::Bool=false, gpu_mem::String="")
